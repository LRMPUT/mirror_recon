...
load_path = '/home/rafal/Models/ral_3d_gen/graspable/4ch'

images_save_path = '/home/rafal/Test/ral_3d_gen/graspable/4ch'
...
_, _, test = get_rgbd_rotation_dataset(path, 0.0, 0.0, 1.0, seed=42)
...
labels = ['rgb', 'depth', 'depth_back', 'depth_pred']
