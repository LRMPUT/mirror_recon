...
save_path = "/mnt/m2/Models/ral_3d_gen_art/4ch"
...
train, valid, test = get_rgbd_rotation_dataset(path, 0.9, 0.1, 0.0, seed=42)
...
try:
    ...
    model = create_unet_model(encoder_model, n_out=1, img_size=(96, 128), n_in=4)
