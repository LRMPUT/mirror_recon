...
load_path = '/home/rafal/Models/ral_3d_gen/graspable'

images_save_path = '/home/rafal/Test/ral_3d_gen/graspable'
...
_, _, test = get_rotation_dataset(path, 0.0, 0.0, 1.0, seed=42)
...
labels = ['rgb', 'rgb_proj', 'depth', 'depth_proj', 'depth_back', 'depth_pred']

results_data = dict(zip(labels, [[] for _ in range(len(labels))]))
l1_losses = []
ssim_losses = []

for i, (x, y) in enumerate(tqdm(test_laoder)):
